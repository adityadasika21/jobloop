...
**FAIL** — 0 critical, 1 high · 4486 chars extracted

Keyword coverage **on extracted text**: 28% exact · 32% allowing word-form variants

| | Check | Result |
|---|---|---|
| ✅ | `text-extractable` | 4486 chars recovered by the text extractor |
