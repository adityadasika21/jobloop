...
| Automate onboarding for new agent use cases (templates, scaffolding, configuration checks) | ✅ met *(responsibility)* | ev-phenom-frm-decides-what-runs |
...
| Familiarity with observability fundamentals (logs/metrics/traces) and production troubleshooting | ✅ met | ev-phenom-frm-tenancy-ops |
